...
def main_menu():
    ...
    while True:
        ...
        main_men_text_welcome = main_men_text.render("Welcome to Dodge-The-Blocks!", True, white)
...
def help():
    ...
    while True:
        ...
        help_src_code = help_text.render("Code: github.com/samaralam7348/Dodge-The-Blocks/", True, white)
